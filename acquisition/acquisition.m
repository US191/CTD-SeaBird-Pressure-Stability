classdef acquisition < handle
  ...
  methods % Public
    ...
    function obj = acquisition()
      ...
      obj.setUicontrols;
      % add listener
      obj.listenerHandle = addlistener(obj,'dataAvailable',@obj.handleEvnt);
    ...
    function setUicontrols(obj)
      ...
      obj.hdlRawHex = uicontrol ( obj.hdlPanelMeasure ,...
        'style' , ' text' ,...
        'String', obj.rawhex,...
        'units', 'normalized', ...
        'HorizontalAlignment', 'left',...
      ...
      obj.hdlMean = uicontrol ( obj.hdlPanelTreat ,...
        'style' , 'Text' ,...
        'String', obj.average,...
        'units', 'normalized', ...
        'HorizontalAlignment', 'left',...
      ...
      obj.hdlMedian = uicontrol ( obj.hdlPanelTreat ,...
        'style' , 'Text' ,...
        'String',obj.med,...
        'units', 'normalized', ...
        'HorizontalAlignment', 'left',...
      ...
      obj.hdlVar = uicontrol ( obj.hdlPanelTreat ,...
        'style' , 'Text' ,...
        'units', 'normalized', ...
        'HorizontalAlignment', 'left',...
        'BackGroundcolor','w',...
      ...
      obj.hdlStandDev = uicontrol ( obj.hdlPanelTreat ,...
        'style' , 'Text' ,...
        'units', 'normalized', ...
        'HorizontalAlignment', 'left',...
        'BackGroundcolor','w',...
  ...
  methods (Access = private)
    ...
    function handleEvnt(obj,~,~)
      set(obj.hdlPressure, 'string', num2str(obj.pressure));
      set(obj.hdlTemperature, 'string', num2str(obj.temperature));
      set(obj.hdlModulo, 'string', num2str(obj.modulo));
      set(obj.hdlRawHex, 'string', num2str(obj.rawhex));
    end
