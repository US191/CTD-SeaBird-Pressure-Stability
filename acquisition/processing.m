classdef processing < handle %us191.ctd
...
%             obj = obj@us191.ctd('data/1263.xml',theSerialPort,'baudrate',theBaudRate,...
...
%             obj.xmlFile = theXmlFile;
        ...
        function setUicontrols(obj)
            ...
            %---------------------------------------------------
            obj.hdlTextStation = uicontrol( obj.hdlPanelSerial ,...
                'style' , 'Text' ,...
...
%            obj.rawFileName = sprintf('%s.hex',FileName) ;
%            obj.dataFileName = sprintf('%s.cnv',FileName) ;
